...
export type ReactGridEvent = Event & {
    reactgrid: RegisteredChanges;
};
export type ChangeObservedKeys = keyof Pick<ReactGridStore, "cells" | "rows" | "columns" | "styledRanges" | "currentBehavior" | "focusedLocation" | "selectedArea" | "colMeasurements">;
